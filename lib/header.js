...
Header.prototype = {
  ...
  parse( buffer, offset ) {
    ...
    this.xmlLengthCompressed = buffer.readUIntBE( offset + 8, 8 )
    this.xmlLengthOriginal = buffer.readUIntBE( offset + 16, 8 )
  ...
  write( buffer, offset ) {
    ...
    buffer.writeUIntBE( this.xmlLengthCompressed, offset + 8, 8 )
    buffer.writeUIntBE( this.xmlLengthOriginal, offset + 16, 8 )
